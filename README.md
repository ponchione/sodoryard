...
- for spec 24, continue from the project browser into native-dialog attachment affordances, readiness actions, settings, and any remaining chain/receipt polish
