...
- for spec 24, continue from the dashboard route into the launch workbench preview, then launch start/navigation and deeper chain monitor/detail polish
