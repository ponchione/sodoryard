...
- for spec 24, continue from launch start/navigation into deeper chain monitor/detail polish, receipt review, project attachments, readiness actions, and settings
