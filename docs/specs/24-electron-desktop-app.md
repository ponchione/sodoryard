...
- Chain detail includes desktop pause/resume/cancel controls plus rendered receipt previews with frontmatter and changed-file hints, and receipts have a desktop detail route for frontmatter, body, chain event review, and backend-validated changed-file open/reveal actions.
