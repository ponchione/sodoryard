...
- The chain monitor route at `/chains` lists recent chains active-first with Shunter Project Memory event activity, text/status filtering, duration, and receipt indicators.
