...
- [ ] Results stored as a `map[string][]string` keyed by concrete type qualified name (e.g., `"goparser.GoParser"`), value is a sorted list of interface qualified names (e.g., `["codeintel.Parser", "io.Closer"]`)
