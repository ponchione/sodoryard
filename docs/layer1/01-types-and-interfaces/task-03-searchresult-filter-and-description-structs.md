...
- [ ] `SearchResult` struct defined in `internal/rag/types.go` with the following fields:
...
- [ ] `Filter` struct defined in `internal/rag/types.go` with the following fields:
...
- [ ] `Description` struct defined in `internal/rag/types.go` with the following fields:
