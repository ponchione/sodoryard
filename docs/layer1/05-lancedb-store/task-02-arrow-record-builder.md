...
- [ ] Internal function `buildArrowRecord(chunks []rag.Chunk, embeddings [][]float32) (arrow.Record, error)` that:
...
- [ ] The embedding dimension count (3584) is sourced from the `rag.DefaultEmbeddingDims` constant (L1-E01), not hardcoded in this file
