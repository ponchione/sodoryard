...
- [ ] A minimal smoke test file exists at `internal/codeintel/treesitter/treesitter_smoke_test.go` that:
...
- [ ] `CGO_ENABLED=1 go test ./internal/codeintel/treesitter/...` passes with no linker errors
