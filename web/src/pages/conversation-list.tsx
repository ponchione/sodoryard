  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-6 p-8">
      <div className="text-center">
        <h1 className="text-3xl font-semibold uppercase tracking-[0.25em] text-primary text-glow-cyan">
          Sodoryard
        </h1>
      ...
      <div className="w-full max-w-4xl">
        <div className="flex gap-2 border border-border bg-input p-1 focus-within:border-primary">
          ...
          <Button
            onClick={handleSend}
            disabled={!input.trim()}
            className="self-end border border-primary bg-primary px-4 py-2 text-xs font-semibold uppercase tracking-widest text-primary-foreground hover:bg-primary/80"
          >
            Send
          </Button>
        </div>
