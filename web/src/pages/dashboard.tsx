...
import { Activity, AlertTriangle, BarChart3, FolderTree, GitBranch, MessageSquare, Play, Rocket, Settings } from "lucide-react";
    ...
    <div className="flex-1 overflow-y-auto px-4 py-6">
      <div className="mx-auto flex max-w-6xl flex-col gap-5">
        ...
        <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
          ...
          <RuntimeMetric label="Local Services" value={runtime?.local_services_status ?? "..."} />
          <RuntimeMetric
